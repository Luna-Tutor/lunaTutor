...
# app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL', 'postgres:///luna_db')
...
>>>>>>> 3864a8a4d41e7b3af9bda91ac41e2bf2171b010f
# landing page
...
def show_question_feed():
    ...
    hastags = Tags.query.all().order_by

    return render_template('feed.html', questions=questions, user=g.user) 
...
def show_subject_questions(subject):
    ...
    questions = Question.query.filter_by(subject=subject)
    
    return render_template('subject-feed.html', questions=questions)
...
@app.route('/q/<:subject>/<:qid>', methods=['GET', 'POST'])
